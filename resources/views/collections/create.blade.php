<x-app-layout>
    <x-header name="Create Collection"/>
    <div class="max-w-[1410px] mx-auto flex gap-x-20 my-20 ">
        <div class="p-5 bg-[#343444] rounded-[10px] min-w-[450px] max-w-[450px] h-fit">
            ...
            <div class="mt-[15px] flex justify-between items-start">
                <div class="flex gap-x-2.5 items-center">
                    <div class="relative bg-[#7A798A] rounded-[21px] w-16 h-16">
                        <svg class="absolute bottom-0 right-0" width="18" height="18" viewBox="0 0 18 18" fill="none"
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="flex gap-x-1.5 items-center">
                            ...
                            <span class="text-[15px] font-bold">{{ $author->name }}</span>
                        </p>
                    </div>
                </div>
